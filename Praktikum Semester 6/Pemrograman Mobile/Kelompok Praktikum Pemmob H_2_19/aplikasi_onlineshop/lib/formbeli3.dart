...
class MyForm3 extends StatelessWidget {
...
class MyFormPage3 extends StatefulWidget {
  const MyFormPage3({Key? key}) : super(key: key);

  @override
  State<MyFormPage3> createState() => _MyFormPage3State();
}

class _MyFormPage3State extends State<MyFormPage3> {
  @override
  Widget build(BuildContext context) {
              ...
              child: TextButton(
                onPressed: () async {
                  await ((value) => riwayat.add(
                        {
                          'namaBarang': "Lunch Box Set Bedebest",
                          'totalBiaya': "Rp.255.000",
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Image(
                      image: AssetImage("assets/lunchbox.JPG"),
                      height: 80,
                      width: 80,
                    ),
                    SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Akan Diterima Pada Tanggal 4 - 7 Desember",
                        style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey.shade400,
                        ),
