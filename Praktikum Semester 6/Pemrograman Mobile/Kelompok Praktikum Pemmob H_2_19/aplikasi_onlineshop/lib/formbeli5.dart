...
class MyForm5 extends StatelessWidget {
  const MyForm5({Key? key}) : super(key: key);
...
class MyFormPage5 extends StatefulWidget {
  const MyFormPage5({Key? key}) : super(key: key);

  @override
  State<MyFormPage5> createState() => _MyFormPage5State();
}

class _MyFormPage5State extends State<MyFormPage5> {
  @override
  Widget build(BuildContext context) {
              ...
              child: TextButton(
                onPressed: () async {
                  await ((value) => riwayat.add(
                        {
                          'namaBarang': "Tas Belanja Ramah Lingkungan",
                          'totalBiaya': "Rp.80.000",
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Image(
                      image: AssetImage("assets/totebag.jpg"),
                      height: 80,
                      width: 80,
                    ),
                    SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Akan Diterima Pada Tanggal 10 - 13 Desember",
                        style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey.shade400,
                        ),
