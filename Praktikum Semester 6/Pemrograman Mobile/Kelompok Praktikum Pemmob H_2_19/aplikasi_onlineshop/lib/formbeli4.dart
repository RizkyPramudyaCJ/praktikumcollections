...
class MyForm4 extends StatelessWidget {
...
class MyFormPage4 extends StatefulWidget {
  const MyFormPage4({Key? key}) : super(key: key);

  @override
  State<MyFormPage4> createState() => _MyFormPage4State();
}

class _MyFormPage4State extends State<MyFormPage4> {
  @override
  Widget build(BuildContext context) {
              ...
              child: TextButton(
                onPressed: () async {
                  await ((value) => riwayat.add(
                        {
                          'namaBarang': "Sedotan Stainless Steel Murah",
                          'totalBiaya': "Rp.111.000",
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Image(
                      image: AssetImage("assets/sedotan.jpg"),
                      height: 80,
                      width: 80,
                    ),
                    SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Akan Diterima Pada Tanggal 15 - 25 Desember",
                        style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey.shade400,
                        ),
