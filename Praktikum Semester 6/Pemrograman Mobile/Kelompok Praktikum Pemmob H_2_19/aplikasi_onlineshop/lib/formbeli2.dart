...
class MyFormPage2 extends StatefulWidget {
  const MyFormPage2({Key? key}) : super(key: key);

  @override
  State<MyFormPage2> createState() => _MyFormPage2State();
}

class _MyFormPage2State extends State<MyFormPage2> {
  @override
  Widget build(BuildContext context) {
              ...
              child: TextButton(
                onPressed: () async {
                  await ((value) => riwayat.add(
                        {
                          'namaBarang': "Botol Minum Stainless 250 ML",
                          'totalBiaya': "Rp.143.000",
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Image(
                      image: AssetImage("assets/tumbler2.jpg"),
                      height: 80,
                      width: 80,
                    ),
                    SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Akan Diterima Pada Tanggal 21 - 27 Desember",
                        style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey.shade400,
                        ),
